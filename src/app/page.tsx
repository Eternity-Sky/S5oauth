...
export default async function Home() {
  ...
  const requestCount = stats?.count || 0;
      ...
      <main className="pt-32 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-6 text-center mb-24 relative">
          ...
          <div className="flex justify-center animate-fade-in">
            <div className="inline-flex items-center gap-8 px-8 py-4 bg-slate-50 rounded-[24px] border border-slate-100 shadow-inner">
              <div className="text-left">
        ...
        <section className="max-w-7xl mx-auto px-6 py-20 text-center border-t border-slate-50">
          ...
          <div className="flex flex-wrap justify-center gap-12 grayscale opacity-40">
            ...
            <div className="flex items-center gap-2">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                <path d="M11.53 2.3A1.85 1.85 0 0 0 10 1.21 1.85 1.85 0 0 0 8.48 2.3L.36 15.64a1.85 1.85 0 0 0 1.6 2.85h16.24a1.85 1.85 0 0 0 1.6-2.85zM12 16.5a1.5 1.5 0 1 1 1.5-1.5 1.5 1.5 0 0 1-1.5 1.5zm1.5-4.5h-3V7h3z" />
              </svg>
              <span className="text-2xl font-black tracking-tighter">
                Next.js
              </span>
            ...
            <div className="flex items-center gap-2">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22.5 15.556c0 1.08-.884 1.956-1.974 1.956h-6.17c-1.09 0-1.974-.876-1.974-1.956v-6.112c0-1.08.884-1.956 1.974-1.956h6.17c1.09 0 1.974.876 1.974 1.956v6.112zM8.474 17.512c-1.09 0-1.974-.876-1.974-1.956v-6.112c0-1.08.884-1.956 1.974-1.956h6.17c1.09 0 1.974.876 1.974 1.956v6.112h-6.17z" />
              </svg>
              <span className="text-2xl font-black tracking-tighter">
                Prisma
              </span>
            ...
            <div className="flex items-center gap-2">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0L.3 20.3h23.4L12 0zm0 4.7l7.7 13.3H4.3L12 4.7z" />
              </svg>
              <span className="text-2xl font-black tracking-tighter">
                Netlify
              </span>
