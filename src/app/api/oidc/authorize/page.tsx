    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-gray-50">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border">
          ...
          <form action={loginWithTurnstile} className="flex flex-col gap-4">
            <input
              type="hidden"
              name="redirectTo"
            ...
            <button
              type="submit"
              className="w-full bg-black text-white px-8 py-3 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-gray-800 transition active:scale-95"
            >
