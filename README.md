...
2. **环境变量**:
  ...
  - `AUTH_MICROSOFT_ENTRA_ID_ID`: Microsoft Entra ID (Azure AD) Client ID。
  - `AUTH_MICROSOFT_ENTRA_ID_SECRET`: Microsoft Entra ID (Azure AD) Client Secret。
  - `AUTH_MICROSOFT_ENTRA_ID_TENANT_ID`: (可选) 特定租户 ID，默认为 `common`。
