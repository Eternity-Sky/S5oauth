...
S5auth 是一个基于 Next.js 和 Prisma 构建的无服务器（Serverless）身份认证提供商，旨在为多个关联网站提供统一的登录体验。它支持 OAuth 2.0 / OIDC 协议，并完美适配 Netlify 和 Cloudflare 部署。
